...
import { IgxGridComponent, DefaultSortingStrategy, ISortingExpression } from 'igniteui-angular';
...
export class GridSortingIndicatorsComponent implements OnInit, AfterViewInit {
    ...
    public ngAfterViewInit() {
        const expressions: ISortingExpression<any>[] | { dir: number; fieldName: string; ignoreCase: boolean; strategy: DefaultSortingStrategy; }[] = [];
